...
HD_PWD='D:/Xilinx/Project/200t/AM_modulation/AM_modulation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AM_modulation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AM_modulation.tcl
