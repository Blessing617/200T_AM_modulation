...
HD_PWD='D:/Xilinx/Project/200t/AM_modulation/AM_modulation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AM_modulation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AM_modulation.tcl -notrace
