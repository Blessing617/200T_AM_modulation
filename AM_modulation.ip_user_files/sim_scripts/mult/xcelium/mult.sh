...
#
# Script generated by Vivado on Tue Feb 20 14:50:15 +0800 2024
...
#
# Usage        : mult.sh
#                mult.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mult.sh [-reset_run]
#                mult.sh [-reset_log]
#                mult.sh [-help]
#
...
#                script (type 'mult.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_10 -libname xbip_pipe_v3_0_6 -libname xbip_bram18k_v3_0_6 -libname mult_gen_v12_0_18 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"
...
# script info
echo -e "mult.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mult.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mult xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mult -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mult_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: mult.sh [-reset_log]\n\
Usage: mult.sh [-keep_index]\n\
