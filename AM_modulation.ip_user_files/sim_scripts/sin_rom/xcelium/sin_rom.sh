...
#
# Script generated by Vivado on Tue Feb 20 15:37:23 +0800 2024
...
#
# Usage        : sin_rom.sh
#                sin_rom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sin_rom.sh [-reset_run]
#                sin_rom.sh [-reset_log]
#                sin_rom.sh [-help]
#
...
#                script (type 'sin_rom.sh -help' for more information).
#
...
# script info
echo -e "sin_rom.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sin_rom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.sin_rom xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.sin_rom -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log sin_rom_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: sin_rom.sh [-step]\n\
Usage: sin_rom.sh [-lib_map_path]\n\
Usage: sin_rom.sh [-reset_run]\n\
Usage: sin_rom.sh [-reset_log]\n\
Usage: sin_rom.sh [-keep_index]\n\
